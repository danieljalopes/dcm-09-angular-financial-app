...
var preload = (swiper) => {
	...
	if (swiper.params.grid && ((_swiper$params$grid$r = swiper.params.grid.rows) !== null && _swiper$params$grid$r !== void 0 ? _swiper$params$grid$r : 1) > 1) {
...
function setBreakpoint() {
	...
	[
		...
		var _moduleApi$disable, _moduleApi$enable;
		...
		if (wasModuleEnabled && !isModuleEnabled) moduleApi === null || moduleApi === void 0 || (_moduleApi$disable = moduleApi.disable) === null || _moduleApi$disable === void 0 || _moduleApi$disable.call(moduleApi);
		if (!wasModuleEnabled && isModuleEnabled) moduleApi === null || moduleApi === void 0 || (_moduleApi$enable = moduleApi.enable) === null || _moduleApi$enable === void 0 || _moduleApi$enable.call(moduleApi);
	});
...
var eventsEmitter = {
	...
	emit(...args) {
		...
		if (typeof args[0] === "string" || Array.isArray(args[0])) {
			...
			const opts = args[0];
			events = opts.events;
			data = (_opts$data = opts.data) !== null && _opts$data !== void 0 ? _opts$data : [];
...
function onResize() {
	var _swiper$params$virtua;
	const swiper = this;
	const { params, el } = swiper;
	if (el && el.offsetWidth === 0) return;
	if (params.breakpoints) swiper.setBreakpoint();
	const { allowSlideNext, allowSlidePrev, snapGrid } = swiper;
	const isVirtual = swiper.virtual && ((_swiper$params$virtua = swiper.params.virtual) === null || _swiper$params$virtua === void 0 ? void 0 : _swiper$params$virtua.enabled);
...
function onTouchEnd(event) {
	...
	let e = (_event$originalEvent = event.originalEvent) !== null && _event$originalEvent !== void 0 ? _event$originalEvent : event;
	...
	if (swiper.allowClick) {
		var _e$path;
		const pathTree = (_e$path = e.path) !== null && _e$path !== void 0 ? _e$path : e.composedPath && e.composedPath();
	...
	if (params.followFinger) currentPos = rtl ? swiper.translate : -swiper.translate;
		...
		var _data$currentTranslat;
		currentPos = -((_data$currentTranslat = data.currentTranslate) !== null && _data$currentTranslat !== void 0 ? _data$currentTranslat : 0);
	}
	...
	if (params.rewind) {
		if (swiper.isBeginning) {
			var _params$virtual;
			rewindLastIndex = ((_params$virtual = params.virtual) === null || _params$virtual === void 0 ? void 0 : _params$virtual.enabled) && swiper.virtual ? swiper.virtual.slides.length - 1 : swiper.slides.length - 1;
...
function onTouchMove(event) {
	var _wrapped$originalEven, _data$startTranslate, _data$currentTranslat2, _data$currentTranslat3, _data$currentTranslat4;
	const swiper = this;
	if (swiper.destroyed) return;
	const data = swiper.touchEventsData;
	...
	const wrapped = event;
	const e = (_wrapped$originalEven = wrapped.originalEvent) !== null && _wrapped$originalEven !== void 0 ? _wrapped$originalEven : wrapped;
	...
	data.isMoved = true;
	const startTranslate = (_data$startTranslate = data.startTranslate) !== null && _data$startTranslate !== void 0 ? _data$startTranslate : 0;
	...
	if (!swiper.allowSlideNext && swiper.swipeDirection === "next" && ((_data$currentTranslat2 = data.currentTranslate) !== null && _data$currentTranslat2 !== void 0 ? _data$currentTranslat2 : 0) < startTranslate) data.currentTranslate = startTranslate;
	if (!swiper.allowSlidePrev && swiper.swipeDirection === "prev" && ((_data$currentTranslat3 = data.currentTranslate) !== null && _data$currentTranslat3 !== void 0 ? _data$currentTranslat3 : 0) > startTranslate) data.currentTranslate = startTranslate;
	...
	swiper.setTranslate((_data$currentTranslat4 = data.currentTranslate) !== null && _data$currentTranslat4 !== void 0 ? _data$currentTranslat4 : 0);
}
...
function onTouchStart(event) {
	...
	const swiper = this;
	if (swiper.destroyed) return;
	const e = (_event$originalEvent2 = event.originalEvent) !== null && _event$originalEvent2 !== void 0 ? _event$originalEvent2 : event;
	const data = swiper.touchEventsData;
...
function loopCreate(slideRealIndex, initial) {
	var _swiper$params$virtua2;
	const swiper = this;
	const { params, slidesEl } = swiper;
	if (!params.loop || swiper.virtual && ((_swiper$params$virtua2 = swiper.params.virtual) === null || _swiper$params$virtua2 === void 0 ? void 0 : _swiper$params$virtua2.enabled)) return;
	const initSlides = () => {
...
function loopDestroy() {
	var _swiper$params$virtua3;
	const swiper = this;
	const { params, slidesEl } = swiper;
	if (!params.loop || !slidesEl || swiper.virtual && ((_swiper$params$virtua3 = swiper.params.virtual) === null || _swiper$params$virtua3 === void 0 ? void 0 : _swiper$params$virtua3.enabled)) return;
	swiper.recalcSlides();
...
function loopFix(options = {}) {
	var _params$virtual2, _slides$activeSlideIn, _swiper$controller;
	...
	swiper.allowSlidePrev = true;
	swiper.allowSlideNext = true;
	if (swiper.virtual && ((_params$virtual2 = params.virtual) === null || _params$virtual2 === void 0 ? void 0 : _params$virtual2.enabled)) {
		if (slideTo) {
			var _swiper$virtual$slide;
			const virtualSlidesLength = swiper.virtual.slides.length;
			const virtualSlidesBefore = (_swiper$virtual$slide = swiper.virtual.slidesBefore) !== null && _swiper$virtual$slide !== void 0 ? _swiper$virtual$slide : 0;
	...
	const activeColIndexWithShift = (gridEnabled ? (_slides$activeSlideIn = slides[activeSlideIndex].column) !== null && _slides$activeSlideIn !== void 0 ? _slides$activeSlideIn : 0 : activeSlideIndex) + (bothDirections && typeof setTranslate === "undefined" ? (centeredSlides ? -slidesPerView / 2 + .5 : 0) - offsetSlidesBefore : 0);
	...
	swiper.allowSlidePrev = allowSlidePrev;
	swiper.allowSlideNext = allowSlideNext;
	const controlled = (_swiper$controller = swiper.controller) === null || _swiper$controller === void 0 ? void 0 : _swiper$controller.control;
	if (controlled && !byController) {
		...
		if (Array.isArray(controlled)) controlled.forEach((c) => {
			if (!c.destroyed && c.params.loop) c.loopFix(_objectSpread2(_objectSpread2({}, loopParams), {}, { slideTo: c.params.slidesPerView === params.slidesPerView ? slideTo : false }));
		});
		else if (controlled instanceof swiper.constructor && controlled.params.loop) controlled.loopFix(_objectSpread2(_objectSpread2({}, loopParams), {}, { slideTo: controlled.params.slidesPerView === params.slidesPerView ? slideTo : false }));
	}
	swiper.__loopFixInProgress__ = false;
	swiper.emit("loopFix");
}
...
function slideNext(speed, runCallbacks = true, internal) {
	...
	const isVirtual = swiper.virtual && ((_params$virtual3 = params.virtual) === null || _params$virtual3 === void 0 ? void 0 : _params$virtual3.enabled);
	if (params.loop) {
...
function slidePrev(speed, runCallbacks = true, internal) {
	var _params$virtual4;
	const swiper = this;
	const { params, snapGrid, slidesGrid, rtlTranslate, enabled, animating } = swiper;
	if (!enabled || swiper.destroyed) return swiper;
	if (typeof speed === "undefined") speed = swiper.params.speed;
	const isVirtual = swiper.virtual && ((_params$virtual4 = params.virtual) === null || _params$virtual4 === void 0 ? void 0 : _params$virtual4.enabled);
	if (params.loop) {
		if (animating && !isVirtual && params.loopPreventsSliding) return false;
	...
	if (params.rewind && swiper.isBeginning) {
		var _swiper$params$virtua4;
		const lastIndex = ((_swiper$params$virtua4 = swiper.params.virtual) === null || _swiper$params$virtua4 === void 0 ? void 0 : _swiper$params$virtua4.enabled) && swiper.virtual ? swiper.virtual.slides.length - 1 : swiper.slides.length - 1;
...
function slideTo(index = 0, speed, runCallbacks = true, internal, initial) {
	...
	const isVirtual = swiper.virtual && ((_swiper$params$virtua5 = swiper.params.virtual) === null || _swiper$params$virtua5 === void 0 ? void 0 : _swiper$params$virtua5.enabled);
	...
	if (params.cssMode) {
		...
		if (speed === 0) {
			var _swiper$params$initia;
			if (isVirtual) {
				swiper.wrapperEl.style.scrollSnapType = "none";
				swiper._immediateVirtual = true;
			}
			if (isVirtual && !swiper._cssModeVirtualInitialSet && ((_swiper$params$initia = swiper.params.initialSlide) !== null && _swiper$params$initia !== void 0 ? _swiper$params$initia : 0) > 0) {
...
function slideToLoop(index = 0, speed, runCallbacks = true, internal) {
	...
	if (swiper.params.loop) {
		var _swiper$params$virtua6;
		if (swiper.virtual && ((_swiper$params$virtua6 = swiper.params.virtual) === null || _swiper$params$virtua6 === void 0 ? void 0 : _swiper$params$virtua6.enabled)) {
			var _swiper$virtual$slide2;
			newIndex = newIndex + ((_swiper$virtual$slide2 = swiper.virtual.slidesBefore) !== null && _swiper$virtual$slide2 !== void 0 ? _swiper$virtual$slide2 : 0);
		} else {
			let targetSlideIndex;
			if (gridEnabled) {
				var _targetSlideEl$column;
				const slideIndex = newIndex * swiper.params.grid.rows;
				const targetSlideEl = swiper.slides.find((slideEl) => Number(slideEl.getAttribute("data-swiper-slide-index")) === slideIndex);
				targetSlideIndex = (_targetSlideEl$column = targetSlideEl === null || targetSlideEl === void 0 ? void 0 : targetSlideEl.column) !== null && _targetSlideEl$column !== void 0 ? _targetSlideEl$column : 0;
			...
			if (gridEnabled) {
				var _targetSlideEl$column2;
				const slideIndex = newIndex * swiper.params.grid.rows;
				const targetSlideEl = swiper.slides.find((slideEl) => Number(slideEl.getAttribute("data-swiper-slide-index")) === slideIndex);
				newIndex = (_targetSlideEl$column2 = targetSlideEl === null || targetSlideEl === void 0 ? void 0 : targetSlideEl.column) !== null && _targetSlideEl$column2 !== void 0 ? _targetSlideEl$column2 : 0;
...
function updateActiveIndex(newActiveIndex) {
	var _swiper$params$virtua7, _params$virtual5;
	const swiper = this;
	const translate = swiper.rtlTranslate ? swiper.translate : -swiper.translate;
	...
	const getVirtualRealIndex = (aIndex) => {
		var _swiper$virtual$slide3;
		const virtualSlides = swiper.virtual.slides;
		let realIndex = aIndex - ((_swiper$virtual$slide3 = swiper.virtual.slidesBefore) !== null && _swiper$virtual$slide3 !== void 0 ? _swiper$virtual$slide3 : 0);
	...
	if (activeIndex === previousIndex && swiper.params.loop && swiper.virtual && ((_swiper$params$virtua7 = swiper.params.virtual) === null || _swiper$params$virtua7 === void 0 ? void 0 : _swiper$params$virtua7.enabled)) {
		swiper.realIndex = getVirtualRealIndex(activeIndex);
		return;
	}
	const gridEnabled = swiper.grid && params.grid && params.grid.rows > 1;
	let realIndex;
	if (swiper.virtual && ((_params$virtual5 = params.virtual) === null || _params$virtual5 === void 0 ? void 0 : _params$virtual5.enabled)) if (params.loop) realIndex = getVirtualRealIndex(activeIndex);
	...
	if (swiper.initialized || swiper.params.runCallbacksOnInit) {
		var _swiper$__lastEmitted;
		if (((_swiper$__lastEmitted = swiper.__lastEmittedRealIndex__) !== null && _swiper$__lastEmitted !== void 0 ? _swiper$__lastEmitted : previousRealIndex) !== realIndex) swiper.emit("realIndexChange");
		swiper.emit("slideChange");
	}
	swiper.__lastEmittedRealIndex__ = realIndex;
}
function updateAutoHeight(speed) {
	var _swiper$params$virtua8;
	const swiper = this;
	const activeSlides = [];
	const isVirtual = swiper.virtual && ((_swiper$params$virtua8 = swiper.params.virtual) === null || _swiper$params$virtua8 === void 0 ? void 0 : _swiper$params$virtua8.enabled);
	let newHeight = 0;
	let i;
...
function updateClickedSlide(el, path) {
	...
	if (slide && slideFound) {
		var _swiper$params$virtua9;
		swiper.clickedSlide = slide;
		if (swiper.virtual && ((_swiper$params$virtua9 = swiper.params.virtual) === null || _swiper$params$virtua9 === void 0 ? void 0 : _swiper$params$virtua9.enabled)) swiper.clickedIndex = parseInt(slide.getAttribute("data-swiper-slide-index"), 10);
...
function updateSlides() {
	...
	const isVirtual = !!(swiper.virtual && ((_params$virtual6 = params.virtual) === null || _params$virtual6 === void 0 ? void 0 : _params$virtual6.enabled));
	...
	const shouldResetSlideSize = params.slidesPerView === "auto" && params.breakpoints && Object.keys(params.breakpoints).filter((key) => {
		...
		return typeof (bp === null || bp === void 0 ? void 0 : bp.slidesPerView) !== "undefined";
	}).length > 0;
	for (let i = 0; i < slidesLength; i += 1) {
		...
		if (isVirtual && params.slidesPerView === "auto") {
			var _params$virtual7;
			if ((_params$virtual7 = params.virtual) === null || _params$virtual7 === void 0 ? void 0 : _params$virtual7.slidesPerViewAutoSlideSize) slideSize = params.virtual.slidesPerViewAutoSlideSize;
			if (slideSize && slide) {
	...
	if (isVirtual && params.loop) {
		var _swiper$virtual$slide4, _swiper$virtual$slide5;
		const size = slidesSizesGrid[0] + spaceBetween;
		const virtualLoopCount = ((_swiper$virtual$slide4 = swiper.virtual.slidesBefore) !== null && _swiper$virtual$slide4 !== void 0 ? _swiper$virtual$slide4 : 0) + ((_swiper$virtual$slide5 = swiper.virtual.slidesAfter) !== null && _swiper$virtual$slide5 !== void 0 ? _swiper$virtual$slide5 : 0);
...
function updateSlidesClasses() {
	var _params$virtual8;
	const swiper = this;
	const { slides, params, slidesEl, activeIndex } = swiper;
	const isVirtual = !!(swiper.virtual && ((_params$virtual8 = params.virtual) === null || _params$virtual8 === void 0 ? void 0 : _params$virtual8.enabled));
	const gridEnabled = swiper.grid && params.grid && params.grid.rows > 1;
	...
	if (isVirtual) if (params.loop) {
		var _swiper$virtual$slide6;
		const virtualSlides = swiper.virtual.slides;
		let slideIndex = activeIndex - ((_swiper$virtual$slide6 = swiper.virtual.slidesBefore) !== null && _swiper$virtual$slide6 !== void 0 ? _swiper$virtual$slide6 : 0);
...
function updateSlidesProgress(translate = this && this.translate || 0) {
	...
	for (let i = 0; i < slides.length; i += 1) {
		var _slide$swiperSlideOff, _slide$swiperSlideSiz;
		const slide = slides[i];
		let slideOffset = (_slide$swiperSlideOff = slide.swiperSlideOffset) !== null && _slide$swiperSlideOff !== void 0 ? _slide$swiperSlideOff : 0;
		if (params.cssMode && params.centeredSlides) {
			var _slides$0$swiperSlide;
			slideOffset -= (_slides$0$swiperSlide = slides[0].swiperSlideOffset) !== null && _slides$0$swiperSlide !== void 0 ? _slides$0$swiperSlide : 0;
		}
		const slideSize = (_slide$swiperSlideSiz = slide.swiperSlideSize) !== null && _slide$swiperSlideSiz !== void 0 ? _slide$swiperSlideSiz : 0;
...
var Swiper = class Swiper {
	constructor(...args) {
		...
		swiper.device = getDevice({ userAgent: (_params$userAgent = params.userAgent) !== null && _params$userAgent !== void 0 ? _params$userAgent : void 0 });
	...
	*/
	...
	getSlideIndex(slideEl) {
		...
		return elementIndex(slideEl) - (firstSlideIndex !== null && firstSlideIndex !== void 0 ? firstSlideIndex : 0);
	}
	...
	*/
	slidesPerViewDynamic(view = "current", exact = false) {
		...
		if (params.centeredSlides) {
			var _slides$activeIndex$s;
			let slideSize = slides[activeIndex] ? Math.ceil((_slides$activeIndex$s = slides[activeIndex].swiperSlideSize) !== null && _slides$activeIndex$s !== void 0 ? _slides$activeIndex$s : 0) : 0;
			let breakLoop = false;
			for (let i = activeIndex + 1; i < slides.length; i += 1) if (slides[i] && !breakLoop) {
				var _slides$i$swiperSlide;
				slideSize += Math.ceil((_slides$i$swiperSlide = slides[i].swiperSlideSize) !== null && _slides$i$swiperSlide !== void 0 ? _slides$i$swiperSlide : 0);
				spv += 1;
				if (slideSize > swiperSize) breakLoop = true;
			}
			for (let i = activeIndex - 1; i >= 0; i -= 1) if (slides[i] && !breakLoop) {
				var _slides$i$swiperSlide2;
				slideSize += (_slides$i$swiperSlide2 = slides[i].swiperSlideSize) !== null && _slides$i$swiperSlide2 !== void 0 ? _slides$i$swiperSlide2 : 0;
				spv += 1;
				if (slideSize > swiperSize) breakLoop = true;
			}
	...
	*/
	update() {
		...
		let translated;
		if (((_params$freeMode = params.freeMode) === null || _params$freeMode === void 0 ? void 0 : _params$freeMode.enabled) && !params.cssMode) {
			setTranslate();
			if (params.autoHeight) swiper.updateAutoHeight();
		} else {
			if ((params.slidesPerView === "auto" || params.slidesPerView > 1) && swiper.isEnd && !params.centeredSlides) {
				var _params$virtual9;
				const slidesLength = swiper.virtual && ((_params$virtual9 = params.virtual) === null || _params$virtual9 === void 0 ? void 0 : _params$virtual9.enabled) ? swiper.virtual.slides.length : swiper.slides.length;
	...
	*/
	...
	mount(element) {
		...
		const initialEl = element !== null && element !== void 0 ? element : swiper.params.el;
		let el = null;
	...
	*/
	init(el) {
		...
		if (swiper.params.loop && swiper.virtual && ((_swiper$params$virtua10 = swiper.params.virtual) === null || _swiper$params$virtua10 === void 0 ? void 0 : _swiper$params$virtua10.enabled)) {
			var _swiper$params$initia2, _swiper$virtual$slide7;
			swiper.slideTo(((_swiper$params$initia2 = swiper.params.initialSlide) !== null && _swiper$params$initia2 !== void 0 ? _swiper$params$initia2 : 0) + ((_swiper$virtual$slide7 = swiper.virtual.slidesBefore) !== null && _swiper$virtual$slide7 !== void 0 ? _swiper$virtual$slide7 : 0), 0, swiper.params.runCallbacksOnInit, false, true);
...
_defineProperty(Swiper, "extendedDefaults", void 0);
_defineProperty(Swiper, "defaults", void 0);
...
function updateSwiper(args) {
	var _currentParams$virtua, _currentParams$virtua2;
	...
	const destroyModule = (mod) => {
		...
		if (mod === "navigation") {
			if (swiper.isElement) {
				var _moduleInstance$prevE, _moduleInstance$nextE;
				(_moduleInstance$prevE = moduleInstance.prevEl) === null || _moduleInstance$prevE === void 0 || _moduleInstance$prevE.remove();
				(_moduleInstance$nextE = moduleInstance.nextEl) === null || _moduleInstance$nextE === void 0 || _moduleInstance$nextE.remove();
			}
			if (currentObj) {
			...
			if (swiper.isElement) {
				var _moduleInstance$el;
				(_moduleInstance$el = moduleInstance.el) === null || _moduleInstance$el === void 0 || _moduleInstance$el.remove();
			}
	...
	if (changedParams.includes("children") && slides && virtual && ((_currentParams$virtua = currentParams.virtual) === null || _currentParams$virtua === void 0 ? void 0 : _currentParams$virtua.enabled)) {
		virtual.slides = slides;
		virtual.update(true);
	} else if (changedParams.includes("virtual") && virtual && ((_currentParams$virtua2 = currentParams.virtual) === null || _currentParams$virtua2 === void 0 ? void 0 : _currentParams$virtua2.enabled)) {
...
//#endregion
//#region node_modules/swiper/shared/get-element-params.mjs
var formatValue = (val) => {
...
function getParams(element, propName, propValue) {
	...
	if (typeof propName === "string" && typeof propValue !== "undefined") attrsList.push({
		name: propName,
		value: isObject(propValue) ? _objectSpread2({}, propValue) : propValue
	});
	...
	if (params.navigation) params.navigation = _objectSpread2({
		prevEl: ".swiper-button-prev",
		nextEl: ".swiper-button-next"
	}, params.navigation !== true ? params.navigation : {});
	else if (params.navigation === false) delete params.navigation;
	if (params.scrollbar) params.scrollbar = _objectSpread2({ el: ".swiper-scrollbar" }, params.scrollbar !== true ? params.scrollbar : {});
	else if (params.scrollbar === false) delete params.scrollbar;
	if (params.pagination) params.pagination = _objectSpread2({ el: ".swiper-pagination" }, params.pagination !== true ? params.pagination : {});
...
var Virtual = ({ swiper, extendParams, on, emit }) => {
	...
	const getTempDOM = () => {
		var _tempDOM;
		return (_tempDOM = tempDOM) !== null && _tempDOM !== void 0 ? _tempDOM : tempDOM = document.createElement("div");
	};
	...
	function update(force, beforeInit, forceActiveIndex) {
		...
		if (beforeInit && !isLoop && (initialSlide !== null && initialSlide !== void 0 ? initialSlide : 0) > 0) return;
		...
		else slidesPerViewNumeric = slidesPerView !== null && slidesPerView !== void 0 ? slidesPerView : 1;
		const groupSize = slidesPerGroup !== null && slidesPerGroup !== void 0 ? slidesPerGroup : 1;
		let slidesAfter;
		let slidesBefore;
		if (centeredSlides) {
...
var Mousewheel = ({ swiper, extendParams, on, emit }) => {
	...
	function handle(event) {
		...
		let positions = swiper.getTranslate() + delta * ((_params$sensitivity = params.sensitivity) !== null && _params$sensitivity !== void 0 ? _params$sensitivity : 1);
		if (positions >= swiper.minTranslate()) positions = swiper.minTranslate();
		if (positions <= swiper.maxTranslate()) positions = swiper.maxTranslate();
		disableParentSwiper = swiper.params.loop ? true : !(positions === swiper.minTranslate() || positions === swiper.maxTranslate());
		if (disableParentSwiper && swiper.params.nested) e.stopPropagation();
		const freeModeParams = swiper.params.freeMode;
		if (!swiper.params.freeMode || !(freeModeParams === null || freeModeParams === void 0 ? void 0 : freeModeParams.enabled)) {
			const newEvent = {
				time: now(),
			...
			if (!ignoreWheelEvents) {
				var _params$sensitivity2;
				lastEventBeforeSnap = void 0;
				let position = swiper.getTranslate() + delta * ((_params$sensitivity2 = params.sensitivity) !== null && _params$sensitivity2 !== void 0 ? _params$sensitivity2 : 1);
				...
				if (freeModeParams === null || freeModeParams === void 0 ? void 0 : freeModeParams.sticky) {
				...
				if (swiper.params.autoplay && (autoplayParams === null || autoplayParams === void 0 ? void 0 : autoplayParams.disableOnInteraction)) swiper.autoplay.stop();
...
function createElementIfNotDefined(swiper, originalParams, params, checkProps) {
	const target = params !== null && params !== void 0 ? params : {};
	const original = originalParams !== null && originalParams !== void 0 ? originalParams : {};
...
var isVirtualEnabled$2 = (swiper) => {
	var _swiper$params$virtua;
	return !!swiper.virtual && !!((_swiper$params$virtua = swiper.params.virtual) === null || _swiper$params$virtua === void 0 ? void 0 : _swiper$params$virtua.enabled);
};
var isFreeModeEnabled = (swiper) => {
	var _swiper$params$freeMo;
	return !!((_swiper$params$freeMo = swiper.params.freeMode) === null || _swiper$params$freeMo === void 0 ? void 0 : _swiper$params$freeMo.enabled);
};
var getSlidesLength = (swiper) => {
	var _swiper$params$grid;
	if (isVirtualEnabled$2(swiper)) return swiper.virtual.slides.length;
	const gridRows = (_swiper$params$grid = swiper.params.grid) === null || _swiper$params$grid === void 0 ? void 0 : _swiper$params$grid.rows;
...
var Pagination = ({ swiper, extendParams, on, emit }) => {
	...
	function onBulletClick(e) {
		var _elementIndex, _swiper$params$slides;
		const bulletEl = e.target.closest(classesToSelector(getParams().bulletClass));
		if (!bulletEl) return;
		e.preventDefault();
		const index = ((_elementIndex = elementIndex(bulletEl)) !== null && _elementIndex !== void 0 ? _elementIndex : 0) * ((_swiper$params$slides = swiper.params.slidesPerGroup) !== null && _swiper$params$slides !== void 0 ? _swiper$params$slides : 1);
		if (swiper.params.loop) {
	...
	function update() {
		...
		const total = swiper.params.loop ? Math.ceil(slidesLength / ((_swiper$params$slides2 = swiper.params.slidesPerGroup) !== null && _swiper$params$slides2 !== void 0 ? _swiper$params$slides2 : 1)) : swiper.snapGrid.length;
		if (swiper.params.loop) {
			var _swiper$params$slides3, _swiper$params$slides4;
			previousIndex = swiper.previousRealIndex || 0;
			current = ((_swiper$params$slides3 = swiper.params.slidesPerGroup) !== null && _swiper$params$slides3 !== void 0 ? _swiper$params$slides3 : 1) > 1 ? Math.floor(swiper.realIndex / ((_swiper$params$slides4 = swiper.params.slidesPerGroup) !== null && _swiper$params$slides4 !== void 0 ? _swiper$params$slides4 : 1)) : swiper.realIndex;
		...
		if (params.type === "bullets" && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
			...
			if (params.dynamicBullets) {
				...
				els.forEach((subEl) => {
					var _bulletSize;
					subEl.style[dim] = `${((_bulletSize = bulletSize) !== null && _bulletSize !== void 0 ? _bulletSize : 0) * (params.dynamicMainBullets + 4)}px`;
				});
			...
			if (params.dynamicBullets) {
				var _bulletSize2, _bulletSize3, _bulletSize4;
				const dynamicBulletsLength = Math.min(bullets.length, params.dynamicMainBullets + 4);
				const bulletsOffset = (((_bulletSize2 = bulletSize) !== null && _bulletSize2 !== void 0 ? _bulletSize2 : 0) * dynamicBulletsLength - ((_bulletSize3 = bulletSize) !== null && _bulletSize3 !== void 0 ? _bulletSize3 : 0)) / 2 - midIndex * ((_bulletSize4 = bulletSize) !== null && _bulletSize4 !== void 0 ? _bulletSize4 : 0);
	...
	function render() {
		...
		if (params.type === "bullets") {
			var _swiper$params$slides5;
			let numberOfBullets = swiper.params.loop ? Math.ceil(slidesLength / ((_swiper$params$slides5 = swiper.params.slidesPerGroup) !== null && _swiper$params$slides5 !== void 0 ? _swiper$params$slides5 : 1)) : swiper.snapGrid.length;
...
var Scrollbar = ({ swiper, extendParams, on, emit }) => {
	...
	function setTranslate() {
		var _swiper$progressLoop;
		const params = getParams();
		if (!params.el || !swiper.scrollbar.el) return;
		const { scrollbar, rtlTranslate: rtl } = swiper;
		const { dragEl, el } = scrollbar;
		const progress = swiper.params.loop ? (_swiper$progressLoop = swiper.progressLoop) !== null && _swiper$progressLoop !== void 0 ? _swiper$progressLoop : 0 : swiper.progress;
	...
	function updateSize() {
		...
		divider = swiper.size / (swiper.virtualSize + ((_swiper$params$slides = swiper.params.slidesOffsetBefore) !== null && _swiper$params$slides !== void 0 ? _swiper$params$slides : 0) - (swiper.params.centeredSlides ? swiper.snapGrid[0] : 0));
	...
	function getPointerPosition(e) {
		var _ref2, _e$clientY, _e$touches2;
		if (swiper.isHorizontal()) {
			var _ref, _e$clientX, _e$touches;
			return (_ref = (_e$clientX = e.clientX) !== null && _e$clientX !== void 0 ? _e$clientX : (_e$touches = e.touches) === null || _e$touches === void 0 || (_e$touches = _e$touches[0]) === null || _e$touches === void 0 ? void 0 : _e$touches.clientX) !== null && _ref !== void 0 ? _ref : 0;
		}
		return (_ref2 = (_e$clientY = e.clientY) !== null && _e$clientY !== void 0 ? _e$clientY : (_e$touches2 = e.touches) === null || _e$touches2 === void 0 || (_e$touches2 = _e$touches2[0]) === null || _e$touches2 === void 0 ? void 0 : _e$touches2.clientY) !== null && _ref2 !== void 0 ? _ref2 : 0;
	}
...
var Parallax = ({ swiper, extendParams, on }) => {
	...
	const setTranslate = () => {
		...
		slides.forEach((slideEl, slideIndex) => {
			var _slideEl$progress, _swiper$params$slides;
			let slideProgress = (_slideEl$progress = slideEl.progress) !== null && _slideEl$progress !== void 0 ? _slideEl$progress : 0;
			if (((_swiper$params$slides = swiper.params.slidesPerGroup) !== null && _swiper$params$slides !== void 0 ? _swiper$params$slides : 1) > 1 && swiper.params.slidesPerView !== "auto") slideProgress += Math.ceil(slideIndex / 2) - progress * (snapGrid.length - 1);
	...
	const setTransition = (duration = ((_swiper$params$speed) => (_swiper$params$speed = swiper.params.speed) !== null && _swiper$params$speed !== void 0 ? _swiper$params$speed : 300)()) => {
...
var Zoom = ({ swiper, extendParams, on, emit }) => {
	...
	function getMaxRatio() {
		var _gesture$imageWrapEl;
		const params = getParams();
		const attr = (_gesture$imageWrapEl = gesture.imageWrapEl) === null || _gesture$imageWrapEl === void 0 ? void 0 : _gesture$imageWrapEl.getAttribute("data-swiper-zoom");
	...
	function onGestureStart(e) {
		...
		if (!gesture.slideEl) {
			var _target$closest, _gesture$slideEl$quer, _gesture$slideEl, _imageEl;
			const target = e.target;
			gesture.slideEl = (_target$closest = target === null || target === void 0 ? void 0 : target.closest(`.${swiper.params.slideClass}, swiper-slide`)) !== null && _target$closest !== void 0 ? _target$closest : void 0;
			if (!gesture.slideEl) gesture.slideEl = swiper.slides[swiper.activeIndex];
			let imageEl = (_gesture$slideEl$quer = (_gesture$slideEl = gesture.slideEl) === null || _gesture$slideEl === void 0 ? void 0 : _gesture$slideEl.querySelector(`.${params.containerClass}`)) !== null && _gesture$slideEl$quer !== void 0 ? _gesture$slideEl$quer : null;
			if (imageEl) {
				var _imageEl$querySelecto;
				imageEl = (_imageEl$querySelecto = imageEl.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]) !== null && _imageEl$querySelecto !== void 0 ? _imageEl$querySelecto : null;
			}
			gesture.imageEl = (_imageEl = imageEl) !== null && _imageEl !== void 0 ? _imageEl : void 0;
			if (imageEl) {
				var _elementParents$;
				gesture.imageWrapEl = (_elementParents$ = elementParents(imageEl, `.${params.containerClass}`)[0]) !== null && _elementParents$ !== void 0 ? _elementParents$ : void 0;
		...
		if (gesture.imageEl) {
			...
			gesture.originX = originX !== null && originX !== void 0 ? originX : 0;
			gesture.originY = originY !== null && originY !== void 0 ? originY : 0;
			gesture.imageEl.style.transitionDuration = "0ms";
		}
		isScaling = true;
	}
	function onGestureChange(e) {
		var _gesture$scaleStart;
		if (!eventWithinSlide(e)) return;
		const params = getParams();
		...
		zoom.scale = gesture.scaleMove / ((_gesture$scaleStart = gesture.scaleStart) !== null && _gesture$scaleStart !== void 0 ? _gesture$scaleStart : 1) * currentScale;
	...
	function onTouchMove(e) {
		var _image$touchesStart$x, _image$touchesStart$y, _image$startX, _image$startY, _image$touchesStart$x4, _image$touchesStart$y4;
		...
		if (Math.max(Math.abs(image.touchesCurrent.x - ((_image$touchesStart$x = image.touchesStart.x) !== null && _image$touchesStart$x !== void 0 ? _image$touchesStart$x : 0)), Math.abs(image.touchesCurrent.y - ((_image$touchesStart$y = image.touchesStart.y) !== null && _image$touchesStart$y !== void 0 ? _image$touchesStart$y : 0))) > 5) swiper.allowClick = false;
		const startX = (_image$startX = image.startX) !== null && _image$startX !== void 0 ? _image$startX : 0;
		const startY = (_image$startY = image.startY) !== null && _image$startY !== void 0 ? _image$startY : 0;
		if (!image.isMoved && !isScaling) {
			var _image$touchesStart$x2, _image$touchesStart$x3, _image$touchesStart$y2, _image$touchesStart$y3;
			if (swiper.isHorizontal() && (Math.floor(image.minX) === Math.floor(startX) && image.touchesCurrent.x < ((_image$touchesStart$x2 = image.touchesStart.x) !== null && _image$touchesStart$x2 !== void 0 ? _image$touchesStart$x2 : 0) || Math.floor(image.maxX) === Math.floor(startX) && image.touchesCurrent.x > ((_image$touchesStart$x3 = image.touchesStart.x) !== null && _image$touchesStart$x3 !== void 0 ? _image$touchesStart$x3 : 0))) {
				image.isTouched = false;
				allowTouchMove();
				return;
			}
			if (!swiper.isHorizontal() && (Math.floor(image.minY) === Math.floor(startY) && image.touchesCurrent.y < ((_image$touchesStart$y2 = image.touchesStart.y) !== null && _image$touchesStart$y2 !== void 0 ? _image$touchesStart$y2 : 0) || Math.floor(image.maxY) === Math.floor(startY) && image.touchesCurrent.y > ((_image$touchesStart$y3 = image.touchesStart.y) !== null && _image$touchesStart$y3 !== void 0 ? _image$touchesStart$y3 : 0))) {
				image.isTouched = false;
				allowTouchMove();
				return;
			}
		...
		image.currentX = image.touchesCurrent.x - ((_image$touchesStart$x4 = image.touchesStart.x) !== null && _image$touchesStart$x4 !== void 0 ? _image$touchesStart$x4 : 0) + startX + scaleRatio * (image.width - originX * 2);
		image.currentY = image.touchesCurrent.y - ((_image$touchesStart$y4 = image.touchesStart.y) !== null && _image$touchesStart$y4 !== void 0 ? _image$touchesStart$y4 : 0) + startY + scaleRatio * (image.height - originY * 2);
	...
	function onTouchEnd() {
		...
		const velocityX = (_velocity$x = velocity.x) !== null && _velocity$x !== void 0 ? _velocity$x : 0;
		const velocityY = (_velocity$y = velocity.y) !== null && _velocity$y !== void 0 ? _velocity$y : 0;
	...
	function zoomIn(e) {
		...
		const params = getParams();
		if (!gesture.slideEl) {
			var _gesture$slideEl$quer2, _gesture$slideEl2, _imageEl2;
			if (e && typeof e !== "number" && "target" in e && e.target) {
				var _e$target$closest;
				gesture.slideEl = (_e$target$closest = e.target.closest(`.${swiper.params.slideClass}, swiper-slide`)) !== null && _e$target$closest !== void 0 ? _e$target$closest : void 0;
			}
			if (!gesture.slideEl) {
				const virtual = swiper.params.virtual;
				if (virtual && virtual.enabled && swiper.virtual) {
					var _elementChildren$;
					gesture.slideEl = (_elementChildren$ = elementChildren(swiper.slidesEl, `.${swiper.params.slideActiveClass}`)[0]) !== null && _elementChildren$ !== void 0 ? _elementChildren$ : void 0;
				} else gesture.slideEl = swiper.slides[swiper.activeIndex];
			}
			let imageEl = (_gesture$slideEl$quer2 = (_gesture$slideEl2 = gesture.slideEl) === null || _gesture$slideEl2 === void 0 ? void 0 : _gesture$slideEl2.querySelector(`.${params.containerClass}`)) !== null && _gesture$slideEl$quer2 !== void 0 ? _gesture$slideEl$quer2 : null;
			if (imageEl) {
				var _imageEl$querySelecto2;
				imageEl = (_imageEl$querySelecto2 = imageEl.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]) !== null && _imageEl$querySelecto2 !== void 0 ? _imageEl$querySelecto2 : null;
			}
			gesture.imageEl = (_imageEl2 = imageEl) !== null && _imageEl2 !== void 0 ? _imageEl2 : void 0;
			if (imageEl) {
				var _elementParents$2;
				gesture.imageWrapEl = (_elementParents$2 = elementParents(imageEl, `.${params.containerClass}`)[0]) !== null && _elementParents$2 !== void 0 ? _elementParents$2 : void 0;
			} else gesture.imageWrapEl = void 0;
		}
		...
		if (e && !(currentScale === 1 && forceZoomRatio)) {
			...
			diffX = offsetX + slideWidth / 2 - ((_touchX = touchX) !== null && _touchX !== void 0 ? _touchX : 0);
			diffY = offsetY + slideHeight / 2 - ((_touchY = touchY) !== null && _touchY !== void 0 ? _touchY : 0);
	...
	function zoomOut() {
		...
		const params = getParams();
		if (!gesture.slideEl) {
			var _gesture$slideEl$quer3, _gesture$slideEl3, _imageEl3;
			const virtual = swiper.params.virtual;
			if (virtual && virtual.enabled && swiper.virtual) {
				var _elementChildren$2;
				gesture.slideEl = (_elementChildren$2 = elementChildren(swiper.slidesEl, `.${swiper.params.slideActiveClass}`)[0]) !== null && _elementChildren$2 !== void 0 ? _elementChildren$2 : void 0;
			} else gesture.slideEl = swiper.slides[swiper.activeIndex];
			let imageEl = (_gesture$slideEl$quer3 = (_gesture$slideEl3 = gesture.slideEl) === null || _gesture$slideEl3 === void 0 ? void 0 : _gesture$slideEl3.querySelector(`.${params.containerClass}`)) !== null && _gesture$slideEl$quer3 !== void 0 ? _gesture$slideEl$quer3 : null;
			if (imageEl) {
				var _imageEl$querySelecto3;
				imageEl = (_imageEl$querySelecto3 = imageEl.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]) !== null && _imageEl$querySelecto3 !== void 0 ? _imageEl$querySelecto3 : null;
			}
			gesture.imageEl = (_imageEl3 = imageEl) !== null && _imageEl3 !== void 0 ? _imageEl3 : void 0;
			if (imageEl) {
				var _elementParents$3;
				gesture.imageWrapEl = (_elementParents$3 = elementParents(imageEl, `.${params.containerClass}`)[0]) !== null && _elementParents$3 !== void 0 ? _elementParents$3 : void 0;
			} else gesture.imageWrapEl = void 0;
		}
		if (!gesture.imageEl || !gesture.imageWrapEl || !gesture.slideEl) return;
		gesture.maxRatio = getMaxRatio();
...
var LinearSpline = class {
	constructor(x, y) {
		...
		_defineProperty(this, "binarySearch", void 0);
		let maxIndex;
		let minIndex;
		let guess;
...
var A11y = ({ swiper, extendParams, on }) => {
	...
	function onEnterOrSpaceKey(e) {
		...
		if (swiper.pagination && swiper.pagination.el && (targetEl === swiper.pagination.el || swiper.pagination.el.contains(targetEl))) {
			if (!targetEl.matches(classesToSelector(paginationParams === null || paginationParams === void 0 ? void 0 : paginationParams.bulletClass))) return;
		}
		...
		if (swiper.pagination && targetEl.matches(classesToSelector(paginationParams === null || paginationParams === void 0 ? void 0 : paginationParams.bulletClass))) targetEl.click();
	}
	...
	function hasClickablePagination() {
		const paginationParams = swiper.params.pagination;
		return hasPagination() && !!(paginationParams === null || paginationParams === void 0 ? void 0 : paginationParams.clickable);
	}
		...
		swiper.pagination.bullets.forEach((bulletEl) => {
			if (paginationParams.clickable) {
				...
				if (!paginationParams.renderBullet) {
					...
					addElLabel(bulletEl, params.paginationBulletMessage.replace(/\{\{index\}\}/, String(((_elementIndex = elementIndex(bulletEl)) !== null && _elementIndex !== void 0 ? _elementIndex : 0) + 1)));
				}
			}
	...
	const init = () => {
		...
		if (params.wrapperLiveRegion) {
			const autoplayParams = swiper.params.autoplay;
			addElLive(wrapperEl, swiper.params.autoplay && (autoplayParams === null || autoplayParams === void 0 ? void 0 : autoplayParams.enabled) ? "off" : "polite");
		}
		initSlides();
...
var History = ({ swiper, extendParams, on }) => {
	...
	const setHistory = (key, index) => {
		...
		const isVirtualEnabled = !!((_swiper$params$virtua = swiper.params.virtual) === null || _swiper$params$virtua === void 0 ? void 0 : _swiper$params$virtua.enabled);
...
var Autoplay = ({ swiper, extendParams, on, emit, params }) => {
	...
	const getSlideDelay = () => {
		var _swiper$params$virtua;
		let activeSlideEl;
		const virtualEnabled = !!((_swiper$params$virtua = swiper.params.virtual) === null || _swiper$params$virtua === void 0 ? void 0 : _swiper$params$virtua.enabled);
...
var Thumb = ({ swiper, extendParams, on }) => {
	...
	function onThumbClick() {
		...
		if (thumbsSwiper.params.loop) {
			var _thumbsSwiper$clicked;
			const attr = (_thumbsSwiper$clicked = thumbsSwiper.clickedSlide) === null || _thumbsSwiper$clicked === void 0 ? void 0 : _thumbsSwiper$clicked.getAttribute("data-swiper-slide-index");
	...
	function update(initial, p) {
		...
		if ((_p$autoScroll = p === null || p === void 0 ? void 0 : p.autoScroll) !== null && _p$autoScroll !== void 0 ? _p$autoScroll : true) autoScroll(initial ? 0 : void 0);
	}
	function autoScroll(slideSpeed) {
		const thumbsSwiper = swiper.thumbs.swiper;
		if (!thumbsSwiper || thumbsSwiper.destroyed) return;
		const thumbsSlidesPerView = thumbsSwiper.params.slidesPerView;
		const slidesPerView = thumbsSlidesPerView === "auto" ? thumbsSwiper.slidesPerViewDynamic() : thumbsSlidesPerView !== null && thumbsSlidesPerView !== void 0 ? thumbsSlidesPerView : 1;
...
var FreeMode = ({ swiper, extendParams, emit, once }) => {
	...
	function onTouchMove() {
		...
		if (data.velocities.length === 0) {
			var _data$touchStartTime;
			data.velocities.push({
				position: touches[swiper.isHorizontal() ? "startX" : "startY"],
				time: (_data$touchStartTime = data.touchStartTime) !== null && _data$touchStartTime !== void 0 ? _data$touchStartTime : now()
			});
		}
		data.velocities.push({
	...
	function onTouchEnd({ currentPos }) {
		var _data$touchStartTime2;
		if (swiper.params.cssMode) return;
		const { wrapperEl, rtlTranslate: rtl, snapGrid, touchEventsData: data } = swiper;
		const params = swiper.params;
		const freeModeParams = getParams();
		const touchEndTime = now();
		const timeDiff = touchEndTime - ((_data$touchStartTime2 = data.touchStartTime) !== null && _data$touchStartTime2 !== void 0 ? _data$touchStartTime2 : touchEndTime);
		...
		if (freeModeParams.momentum) {
			...
			if (newPosition < swiper.maxTranslate()) {
				...
				if (Math.abs(snapGrid[nextSlide] - newPosition) < Math.abs(((_snapGrid = snapGrid[nextSlide - 1]) !== null && _snapGrid !== void 0 ? _snapGrid : snapGrid[nextSlide]) - newPosition) || swiper.swipeDirection === "next") newPosition = snapGrid[nextSlide];
...
var Grid = ({ swiper, extendParams, on }) => {
	...
	const getSpaceBetween = () => {
		var _swiper$params$spaceB;
		let spaceBetween = (_swiper$params$spaceB = swiper.params.spaceBetween) !== null && _swiper$params$spaceB !== void 0 ? _swiper$params$spaceB : 0;
		if (typeof spaceBetween === "string" && spaceBetween.indexOf("%") >= 0) spaceBetween = parseFloat(spaceBetween.replace("%", "")) / 100 * swiper.size;
		else if (typeof spaceBetween === "string") spaceBetween = parseFloat(spaceBetween);
		return spaceBetween;
	};
	...
	const initSlides = (slides) => {
		...
		if (slidesPerView !== "auto" && fill === "row") slidesNumberEvenToRows = Math.max(slidesNumberEvenToRows, Math.floor(slidesPerView !== null && slidesPerView !== void 0 ? slidesPerView : 1) * rows);
	...
	const updateSlide = (i, slide, slides) => {
		...
		let column;
		let row;
		if (fill === "row" && (slidesPerGroup !== null && slidesPerGroup !== void 0 ? slidesPerGroup : 1) > 1) {
			const groupsPer = slidesPerGroup !== null && slidesPerGroup !== void 0 ? slidesPerGroup : 1;
	...
	const onInit = () => {
		var _gridParams$rows;
		const gridParams = swiper.params.grid;
		wasMultiRow = !!(gridParams && ((_gridParams$rows = gridParams.rows) !== null && _gridParams$rows !== void 0 ? _gridParams$rows : 1) > 1);
	};
	const onUpdate = () => {
		var _gridParams$rows2;
		const { params, el } = swiper;
		const gridParams = params.grid;
		const isMultiRow = !!(gridParams && ((_gridParams$rows2 = gridParams.rows) !== null && _gridParams$rows2 !== void 0 ? _gridParams$rows2 : 1) > 1);
		if (wasMultiRow && !isMultiRow) {
			el.classList.remove(`${params.containerModifierClass}grid`, `${params.containerModifierClass}grid-column`);
			numFullColumns = 1;
			swiper.emitContainerClasses();
...
function addSlide(index, slides) {
	...
	if (params.loop) {
		var _swiper$loopedSlides;
		activeIndexBuffer -= (_swiper$loopedSlides = swiper.loopedSlides) !== null && _swiper$loopedSlides !== void 0 ? _swiper$loopedSlides : 0;
		swiper.loopDestroy();
		swiper.recalcSlides();
	}
	...
	if (params.loop) {
		var _swiper$loopedSlides2;
		swiper.slideTo(newActiveIndex + ((_swiper$loopedSlides2 = swiper.loopedSlides) !== null && _swiper$loopedSlides2 !== void 0 ? _swiper$loopedSlides2 : 0), 0, false);
...
function removeSlide(slidesIndexes) {
	...
	let activeIndexBuffer = activeIndex;
	if (params.loop) {
		var _swiper$loopedSlides3;
		activeIndexBuffer -= (_swiper$loopedSlides3 = swiper.loopedSlides) !== null && _swiper$loopedSlides3 !== void 0 ? _swiper$loopedSlides3 : 0;
		swiper.loopDestroy();
	}
	...
	if (!params.observer || swiper.isElement) swiper.update();
	if (params.loop) {
		var _swiper$loopedSlides4;
		swiper.slideTo(newActiveIndex + ((_swiper$loopedSlides4 = swiper.loopedSlides) !== null && _swiper$loopedSlides4 !== void 0 ? _swiper$loopedSlides4 : 0), 0, false);
	} else swiper.slideTo(newActiveIndex, 0, false);
}
...
var EffectFade = ({ swiper, extendParams, on }) => {
	...
	const setTranslate = () => {
		...
		for (let i = 0; i < slides.length; i += 1) {
			var _slideEl$swiperSlideO, _slideEl$progress;
			const slideEl = slides[i];
			let tx = -((_slideEl$swiperSlideO = slideEl.swiperSlideOffset) !== null && _slideEl$swiperSlideO !== void 0 ? _slideEl$swiperSlideO : 0);
			...
			const slideProgress = (_slideEl$progress = slideEl.progress) !== null && _slideEl$progress !== void 0 ? _slideEl$progress : 0;
			let slideOpacity;
...
var EffectCube = ({ swiper, extendParams, on }) => {
	...
	const recreateShadows = () => {
		...
		swiper.slides.forEach((slideEl) => {
			var _slideEl$progress;
			const progress = Math.max(Math.min((_slideEl$progress = slideEl.progress) !== null && _slideEl$progress !== void 0 ? _slideEl$progress : 0, 1), -1);
	...
	const setTranslate = () => {
		...
		for (let i = 0; i < slides.length; i += 1) {
			var _slideEl$progress2;
			const slideEl = slides[i];
			let slideIndex = i;
			if (isVirtual) {
				var _slideEl$getAttribute;
				slideIndex = parseInt((_slideEl$getAttribute = slideEl.getAttribute("data-swiper-slide-index")) !== null && _slideEl$getAttribute !== void 0 ? _slideEl$getAttribute : "0", 10);
			}
			...
			const progress = Math.max(Math.min((_slideEl$progress2 = slideEl.progress) !== null && _slideEl$progress2 !== void 0 ? _slideEl$progress2 : 0, 1), -1);
			let tx = 0;
			let ty = 0;
			let tz = 0;
			if (slideIndex % 4 === 0) {
	...
	const setTransition = (duration) => {
		...
		if (((_swiper$params$cubeEf = swiper.params.cubeEffect) === null || _swiper$params$cubeEf === void 0 ? void 0 : _swiper$params$cubeEf.shadow) && !swiper.isHorizontal()) {
...
var EffectFlip = ({ swiper, extendParams, on }) => {
	...
	const recreateShadows = () => {
		...
		swiper.slides.forEach((slideEl) => {
			var _slideEl$progress;
			let progress = (_slideEl$progress = slideEl.progress) !== null && _slideEl$progress !== void 0 ? _slideEl$progress : 0;
	...
	const setTranslate = () => {
		...
		for (let i = 0; i < slides.length; i += 1) {
			var _slideEl$progress2, _slideEl$swiperSlideO;
			const slideEl = slides[i];
			let progress = (_slideEl$progress2 = slideEl.progress) !== null && _slideEl$progress2 !== void 0 ? _slideEl$progress2 : 0;
			if (params.limitRotation) progress = Math.max(Math.min(progress, 1), -1);
			const offset = (_slideEl$swiperSlideO = slideEl.swiperSlideOffset) !== null && _slideEl$swiperSlideO !== void 0 ? _slideEl$swiperSlideO : 0;
...
var EffectCoverflow = ({ swiper, extendParams, on }) => {
	...
	const setTranslate = () => {
		...
		for (let i = 0, length = slides.length; i < length; i += 1) {
			var _slideEl$swiperSlideO;
			const slideEl = slides[i];
			const slideSize = slidesSizesGrid[i];
			const centerOffset = (center - ((_slideEl$swiperSlideO = slideEl.swiperSlideOffset) !== null && _slideEl$swiperSlideO !== void 0 ? _slideEl$swiperSlideO : 0) - slideSize / 2) / slideSize;
...
var EffectCreative = ({ swiper, extendParams, on }) => {
	...
	const setTranslate = () => {
		...
		if (isCenteredSlides) {
			var _swiper$params$slides;
			const margin = slidesSizesGrid[0] / 2 - ((_swiper$params$slides = swiper.params.slidesOffsetBefore) !== null && _swiper$params$slides !== void 0 ? _swiper$params$slides : 0);
			wrapperEl.style.transform = `translateX(calc(50% - ${margin}px))`;
		}
		for (let i = 0; i < slides.length; i += 1) {
			var _slideEl$progress, _slideEl$swiperSlideO;
			const slideEl = slides[i];
			const slideProgress = (_slideEl$progress = slideEl.progress) !== null && _slideEl$progress !== void 0 ? _slideEl$progress : 0;
			const progress = Math.min(Math.max(slideProgress, -params.limitProgress), params.limitProgress);
			let originalProgress = progress;
			if (!isCenteredSlides) {
				var _slideEl$originalProg;
				originalProgress = Math.min(Math.max((_slideEl$originalProg = slideEl.originalProgress) !== null && _slideEl$originalProg !== void 0 ? _slideEl$originalProg : 0, -params.limitProgress), params.limitProgress);
			}
			const offset = (_slideEl$swiperSlideO = slideEl.swiperSlideOffset) !== null && _slideEl$swiperSlideO !== void 0 ? _slideEl$swiperSlideO : 0;
			const t = [
...
var EffectCards = ({ swiper, extendParams, on }) => {
	...
	const setTranslate = () => {
		...
		for (let i = 0; i < slides.length; i += 1) {
			var _slideEl$progress, _slideEl$swiperSlideO, _swiper$params$virtua;
			const slideEl = slides[i];
			const slideProgress = (_slideEl$progress = slideEl.progress) !== null && _slideEl$progress !== void 0 ? _slideEl$progress : 0;
			const progress = Math.min(Math.max(slideProgress, -4), 4);
			let offset = (_slideEl$swiperSlideO = slideEl.swiperSlideOffset) !== null && _slideEl$swiperSlideO !== void 0 ? _slideEl$swiperSlideO : 0;
			...
			if (swiper.params.centeredSlides && swiper.params.cssMode) {
				var _slides$0$swiperSlide;
				offset -= (_slides$0$swiperSlide = slides[0].swiperSlideOffset) !== null && _slides$0$swiperSlide !== void 0 ? _slides$0$swiperSlide : 0;
			}
			let tX = swiper.params.cssMode ? -offset - swiper.translate : -offset;
			let tY = 0;
			...
			const slideIndex = swiper.virtual && ((_swiper$params$virtua = swiper.params.virtual) === null || _swiper$params$virtua === void 0 ? void 0 : _swiper$params$virtua.enabled) ? swiper.virtual.from + i : i;
			const isSwipeToNext = (slideIndex === activeIndex || slideIndex === activeIndex - 1) && progress > 0 && progress < 1 && (isTouched || swiper.params.cssMode) && (currentTranslate !== null && currentTranslate !== void 0 ? currentTranslate : 0) < (startTranslate !== null && startTranslate !== void 0 ? startTranslate : 0);
			const isSwipeToPrev = (slideIndex === activeIndex || slideIndex === activeIndex + 1) && progress < 0 && progress > -1 && (isTouched || swiper.params.cssMode) && (currentTranslate !== null && currentTranslate !== void 0 ? currentTranslate : 0) > (startTranslate !== null && startTranslate !== void 0 ? startTranslate : 0);
...
Swiper.use(modules);
//#endregion
//#region node_modules/swiper/swiper-element-bundle.mjs
/**
* Swiper Custom Element 14.2.0
* Most modern mobile touch slider and framework with hardware accelerated transitions
* https://swiperjs.com
*
* Copyright 2014-2026 Vladimir Kharlampidi
...
var SwiperContainer = class extends ClassToExtend {
	constructor() {
		...
		_defineProperty(this, "swiperParams", {});
		_defineProperty(this, "passedParams", {});
		_defineProperty(this, "injectStyles", void 0);
		_defineProperty(this, "injectStylesUrls", void 0);
		_defineProperty(this, "slideSlots", 0);
		_defineProperty(this, "rendered", void 0);
		_defineProperty(this, "nested", void 0);
	...
	initialize() {
		...
		this.render();
		this.swiper = new Swiper(this.shadowRoot.querySelector(".swiper"), _objectSpread2(_objectSpread2(_objectSpread2({}, swiperParams.virtual ? {} : { observer: true }), swiperParams), {}, {
	...
	updateSwiperOnPropChange(propName, propValue) {
		...
		updateSwiper(_objectSpread2(_objectSpread2(_objectSpread2({
			swiper: this.swiper,
			...
			prevEl: ".swiper-button-prev",
			nextEl: ".swiper-button-next"
		} : {}), propName === "pagination" && passedParams[propName] ? { paginationEl: ".swiper-pagination" } : {}), propName === "scrollbar" && passedParams[propName] ? { scrollbarEl: ".swiper-scrollbar" } : {}));
	}
...
var SwiperSlide = class extends ClassToExtend {
	constructor() {
		...
		_defineProperty(this, "swiperLoopMoveDOM", void 0);
		this.attachShadow({ mode: "open" });
	}
	render() {
